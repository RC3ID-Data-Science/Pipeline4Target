...
process Filtering {
    ...
    gatk VariantFiltration --R ${ref} --mask ${mask} --V ${called_vcf}_raw.indels.vcf --filter-expression "QUAL < 30.0 || QD < 2.0 || FS > 60.0 || MQ < 40.0" --filter-name "FAILED" --O ${called_vcf}_flagged.indels.vcf
    """
