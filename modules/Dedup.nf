...
process Dedup {
    ...
    output:
        ...
        path "${bwa_aligned}_dedup.bai", emit: bam_processed_idx
    ...
    gatk MarkDuplicates --REMOVE_DUPLICATES true --CREATE_INDEX true --I ${bwa_aligned}_rg.bam --M ${bwa_aligned}_metrics.txt --O ${bwa_aligned}_dedup.bam
    """
